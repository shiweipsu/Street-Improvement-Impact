...
Mass Avenue corridor has installed separated bike lane in 2008 with travel lane removal. The control corridor is another section on Mass Ave without any improvement.
...
The difference terms for the the Shelby and Prospect corridors are all large, negative and significant signaling a negative causal relationship between the placement of new cycling infrastructure and sales tax receipts. With this specific model specification the introduction of new cycling infrastructure resulted in a loss of at least $210,000 if compared to Meridian or as much as \$215,000 in comparison to Shelby. 

###4.1.3 Difference-in-Difference QCEW

The difference terms for Prospect and Shelby are large, negative and significant, signaling a negative effect of bike lane installation on both employment and quarterly wages. Specifically, Virginia Avenue lost nearly 193 and 176 jobs compared to Prospect and Shelby, respectively, due to the bike lane given our specification. Beyond the loss of those jobs, Virginia Ave also lost nearly 1 million dollars to both of the corridors. These results are puzzling given the fact that the corridor terms in the model are either non-significant or positive and significant meaning that Virginia Ave performs better compared to the other corridors alone, not taking the construction period into account. 

Compared to the descriptive data these results are puzzling.
...
Overall, the results show a rather mixed set of conclusions regarding the effect of new bike lane infrastructure placement on employment, wages and sales tax in Indianapolis. Descriptive data for both corridors, but particularly the Virginia Ave corridor shows a generally positive growth trend in all metrics over time. When modeling these effects using the DiD and ITS models we have mixed results. The DiD specifications are generally negative for both corridors, sometimes with surprisingly large numbers, but the ITS specifications are generally non-significant or actually positive signalling a positing effect of the new infrastructure. 

Unfortunately, our models do not give us a definitive account of the effect new bike lane infrastructure has on these corridors. But while it is not definitive this study still offers some enlightenment. First, the lack of a definitive conclusion, while disappointing, still counters the generally negative opinion certain business leaders and policymakers have of new cycling infrastructure placement in commercial corridors. Both our descriptive data and ITS models show a not great effect of the new infrastructure on the growth of new jobs or wages, depending on the corridor, because most of the trends, whether positive or negative, pre-date and continue through the construction periods. There are a variety of reasons why this may be the case, the simplest one being that new cycling infrastructure construction was not so disruptive as to have a major impact in any given direction. Beyond that there are questions as to what are the overall impacts of new construction on traffic flow and other variables that we do not have data for that may be better predictors of commercial success or failure. 

On a more positive note, including different data sources, such as the LEHD and the QCEW, does give us a better, more rounded view of what is actually going on with these corridors and the story is generally positive. Most every corridor has positive employment, sales tax and wage growth and we see that reflected across all of our data sources. While additional economic data may be useful, we probably require more ancillary data regarding traffic, the built environment and other variables to truly isolate the effect of the new construction. As of right now, the data may be too noisy, or in the case of Massachusetts, too small to truly isolate plausible effects.
