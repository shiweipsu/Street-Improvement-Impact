...
![Virginia Avenue Corridor](images/seattle_2nd_ave.png)
...
meridian <- indy_corridor %>% filter(Group==1, Type=="Control: Meridian Ave", year==conyear) %>% employ_ratio_test(.)
...
![Mass Avenue Corridor](images/seattle_2nd_ave.png)
