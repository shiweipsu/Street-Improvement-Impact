...
qc1 <- ggplot(va_qcew %>%  filter(naics_code == "722"), 
  ...
  scale_shape_manual(name = "Corridor Type", labels = c("Treatment", "Control"), 
                     values = c("triangle", "circle")) +
  scale_color_manual(name = "Corridor Name", labels = c("Meridian", "Prospect", "Shelby", "Virginia"),
                     values = c("#1b9e77", "#d96f02", "#7570b3", "#e7298a"))
