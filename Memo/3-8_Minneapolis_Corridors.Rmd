...
river_agg <- riverside_qcew %>% 
 filter(year_quarter == "2009 Q1") %>% 
  select(corridors, street_type, estab_base = establishments, base_wage = total_wages, 
         base_avg_emp = avg_emp)
...
qc_1 <- ggplot(riverside_qcew, 
  ...
  theme_minimal() +
  labs(x = "Quarter", y = "", title = "Riverside Ave Food and Drinking Places\n Employment Change",
