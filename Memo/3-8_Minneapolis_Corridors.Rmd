...
central_agg_retail_plot <- ggplot(central_agg,aes(x=year, y=CNS07_,group=Type,colour=Type,shape=Type))+
...
central_agg_accom_plot <- ggplot(central_agg,aes(x=year, y=CNS18,group=Type,colour=Type,shape=Type))+
  ...
  scale_x_continuous(breaks=c(2004,2006,2008,2010,2012,2014,2016)) +
  theme_minimal() +
  labs(title = "Resturaunt Sales Comparison: Central Ave", x="Year",y="Sales Tax") +
  scale_y_continuous(labels = scales::dollar)
...
plot_grid(central_agg_idx_retail_plot, central_agg_idx_accom_plot, align = "h")
...
lyndale_agg_retail_plot <- ggplot(lyndale_agg,aes(x=year, y=CNS07,group=Type,colour=Type,shape=Type))+
  ...
  scale_x_continuous(breaks=c(2004,2006,2008,2010,2012,2014,2016)) +
  theme_minimal() +
  labs(title = "Retail Sales Comparison: Lyndale Ave", x="Year",y="Sales Tax") +
  scale_y_continuous(labels == scales::dollar)
...
lyndale_agg_accom_plot <- ggplot(lyndale_agg,aes(x=year, y=CNS18,group=Type,colour=Type,shape=Type))+
  ...
  scale_x_continuous(breaks=c(2004,2006,2008,2010,2012,2014,2016)) +
  theme_minimal() +
  labs(title = "Resturaunt Sales Comparison: Lyndale Ave", x="Year",y="Sales Tax") +
  scale_y_continuous(labels = scales::dollar)
