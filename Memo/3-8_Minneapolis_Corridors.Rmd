...
source("Code/corridor_comparison_functions.R")

minn_corridor <- st_read("C:/Users/Street Improvement/Minneapolis/minn_corridor_lehd_wgs84.geojson")

#add new colume of construct year as numeric

minn_lehd <- st_read("C:/Users/Street Improvement/Minneapolis/minn_lehd.geojson") %>% as.data.frame()
