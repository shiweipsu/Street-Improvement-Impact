...
riverside_growth <- minn_growth %>%  
  mutate(year=as.numeric(as.character(year))) %>% 
  filter(Group==1, grouptype=="improvement", year<=2008) 
cedar_growth <- minn_growth %>%  
  mutate(year=as.numeric(as.character(year))) %>% 
  filter(Group==1, grouptype=="control", year<=2008) 

t.test(riverside_growth$biz_growth,cedar_growth$biz_growth)
t.test(riverside_growth$retail_growth,cedar_growth$retail_growth)
t.test(riverside_growth$food_accom_growth,cedar_growth$food_accom_growth)
...
lyndale_growth <- minn_growth %>%  
  mutate(year=as.numeric(as.character(year))) %>% 
  filter(Group==4, grouptype=="improvement", year<=2008) 
grand_growth <- minn_growth %>%  
  mutate(year=as.numeric(as.character(year))) %>% 
  filter(Group==4, grouptype=="control", year<=2008) 

t.test(lyndale_growth$biz_growth,grand_growth$biz_growth)
t.test(lyndale_growth$retail_growth,grand_growth$retail_growth)
t.test(lyndale_growth$food_accom_growth,grand_growth$food_accom_growth)
...
second_growth <- minn_growth %>%  
  mutate(year=as.numeric(as.character(year))) %>% 
  filter(Group==5, grouptype=="improvement", year<=2011) 
brd_growth <- minn_growth %>%  
  mutate(year=as.numeric(as.character(year))) %>% 
  filter(Group==5, grouptype=="control", year<=2011) 

t.test(second_growth$biz_growth,brd_growth$biz_growth)
t.test(second_growth$retail_growth,brd_growth$retail_growth)
t.test(second_growth$food_accom_growth,brd_growth$food_accom_growth)
```
...
riverside_agg_accom <- city_agg_index_trend_one_control_plot(riverside_agg_idx, industry = "Accommodations", corridor_name = "Riverside Ave.", control_corridor = "Cedar Ave.", industry_code = "CNS18_sd", construct_year = 2009, end_year = 2010)
...
central_agg_idx_retail <- city_agg_index_trend_one_control_plot(df_plot = central_agg, industry = "Retail", corridor_name = "Central Ave.", control_corridor = "University Ave,", industry_code = "CNS07_sd", construct_year = 2012, end_year = 2013)

central_agg_idx_accom <- city_agg_index_trend_one_control_plot(df_plot = central_agg, industry = "Accommodations", corridor_name = "Central Ave.", control_corridor = "University Ave,", industry_code = "CNS18_sd", construct_year = 2012, end_year = 2013)
