...
riverside_agg_accom_plot <- ggplot(riverside_agg,aes(x=year, y=CNS18,group=Type,colour=Type,shape=Type))+
  ...
  scale_x_continuous(breaks=c(2004,2006,2008,2010,2012,2014,2016)) +
  theme_minimal() +
  labs(title = "Resturaunt Sales Comparison: Riverside Ave", x="Year",y="Sales Tax") +
  scale_y_continuous(labels = scales::dollar)
...
franklin_agg_accom_plot <- ggplot(franklin_agg,aes(x=year, y=CNS18_,group=Type,colour=Type,shape=Type))+
  ...
  scale_x_continuous(breaks=c(2004,2006,2008,2010,2012,2014,2016)) +
  theme_minimal() +
  labs(title = "Resturaunt Sales Comparison: Franklin Ave", x="Year",y="Sales Tax") +
  scale_y_continuous(labels = scales::dollar)
...
[indexed sales tax values insert]
...
### 4.4.1 Employment Trend Comparisons
...
### 4.4.3 Difference-in-Difference
...
### 4.5.2 Employment Trend Comparisons
