...
![]("C:\\Users\\elmue\\Desktop\\Street-Improvement-Impact\\Memo\\images\\minneapolis_riverside_corridor_blkgrp.png")
...
riverside <- minn_corridor %>% filter(Name == "Riverside Ave (improvement site)", year == "BuildStart-1")
...
![]("C:\\Users\\elmue\\Desktop\\Street-Improvement-Impact\\Memo\\images\\minneapolis_franklin_corridor_blkgrp.png")
...
![]("C:\\Users\\elmue\\Desktop\\Street-Improvement-Impact\\Memo\\images\\minneapolis_central_ave_corridor_blkgrp.png")
...
![]("C:\\Users\\elmue\\Desktop\\Street-Improvement-Impact\\Memo\\images\\minneapolis_lyndale_corridor_blkgrp.png")
...
![North 2nd Street Corridor]("C:\\Users\\elmue\\Desktop\\Street-Improvement-Impact\\Memo\\images\\minneapolis_north_2ndstreet_corridor_blkgrp.png")
...
riverside_plot$Type <- factor(riverside_plot$Type, levels = rev(levels(riverside_plot$Type)))

#making the plot

ats_riverside <- ggplot(riverside_plot, aes(x=as.numeric(as.character(year)), y=CNS07_sd, group=Type,colour=Type,shape=Type)) + geom_line() +
  ...
  scale_fill_discrete(name = "Corridor Type")
