...
For the QCEW models only the slope change term in the total wages model is significant and positive. This means that the rate of wage growth increased after the cycling infrastructure was installed. The other terms and the other model all return coefficients significant at the 90% level which does not meet our thresholds.
