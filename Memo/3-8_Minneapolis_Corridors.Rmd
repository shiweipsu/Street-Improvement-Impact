...
#riverside absolute table and plot
# riverside_agg <- agg_trend_table(minn_corridor, group = 1)
# 
# riverside_agg_retail <- agg_trend_plot(df_plot = riverside_agg, industry = "Retail", corridor_name = "Riverside Ave.",industry_code = "CNS07", construct_year = 2009,end_year = 2010)
# 
# riverside_agg_accom <- agg_trend_plot(df_plot = riverside_agg, industry = "Accommodations", corridor_name = "Riverside Ave.",industry_code = "CNS18", construct_year = 2009,end_year = 2010)

#riverside index table and plot
riverside_agg_idx <- agg_index_trend_table(minn_corridor, group = 1, construct_year = 2009)

# riverside_agg_retail_idx_plot <- agg_index_trend_plot(riverside_agg_idx, industry = "Retail", corridor_name = "Riverside Ave.",industry_code = "CNS07_sd", construct_year = 2009, end_year = 2010)
# 
# riverside_agg_accom_idx_plot <- agg_index_trend_plot(riverside_agg_idx, industry = "Accommodations", corridor_name = "Riverside Ave.",industry_code = "CNS18_sd", construct_year = 2009, end_year = 2010)
# 
