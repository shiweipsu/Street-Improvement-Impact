...
riverside_agg_plot <- agg_index_trend_plot(riverside_agg, industry = "Retail", corridor_name = "Riverside Ave.",industry_code = "CNS07_sd", construct_year = 2009, end_year = 2010)
...
riverside_agg_plot <- agg_index_trend_plot(riverside_agg, industry = "Accommodations", corridor_name = "Riverside Ave.",industry_code = "CNS18_sd", construct_year = 2009, end_year = 2010)
...
franklin_agg_plot <- agg_index_trend_plot(franklin_agg, industry = "Retail", industry_code = "CNS07_sd", construct_year = 2011, end_year = 2012, corridor_name = "Franklin Ave. Corridor")
...
franklin_agg_plot <- agg_index_trend_plot(franklin_agg, industry = "Accommodations", industry_code = "CNS18_sd", construct_year = 2011, end_year = 2012, corridor_name = "Frankline Ave. Corridor")
...
central_agg_plot <- agg_index_trend_plot(central_agg, industry = "Retail", corridor_name = "Central Ave.", industry_code = "CNS07_sd", construct_year = 2012, end_year = 2013)
...
agg_index_trend_plot(central_agg, industry = "Accommodation", corridor_name = "Central Ave.", industry_code = "CNS18_sd", construct_year = 2012, end_year = 2013)
...
agg_index_trend_plot(lyndale_trend, industry = "Retail", industry_code = "CNS07_sd", construct_year = 2008, end_year = 2009, corridor_name = "Lyndale Ave. S")
```
...
agg_index_trend_plot(lyndale_trend, industry = "Accommodations", industry_code = "CNS18_sd", construct_year = 2008, end_year = 2009, corridor_name = "Lyndale Ave. S")
```
...
agg_index_trend_plot(north_agg, industry = "Retail", corridor_name = "North 2nd St.", industry_code = "CNS07_sd", construct_year = 2011, end_year = 2012)
...
agg_index_trend_plot(north_agg, industry = "Accommodation", corridor_name = "North 2nd St.", industry_code = "CNS18_sd", construct_year = 2011, end_year = 2012)
...
stargazer(franklin_agg_did[[1]], franklin_agg_did[[2]], franklin_agg_did[[3]], title = "Franklin Ave. Corridor Difference-in-Difference Estimates", column.labels  = c("Retail Emp.", "Accomodations Emp.", "'Business' Emp."), type = "text")
...
stargazer(franklin_its[[1]], franklin_its[[2]], franklin_its[[3]], type = "text", title = "Interrupted Time Series- Franklin Ave.", column.labels = c("Retail Emp.", "Accommodations Emp.", "'Business' Emp."))
...
stargazer(central_its[[1]], central_its[[2]], central_its[[3]], type = "text", title = "Interrupted Time Series- Central Ave.", column.labels = c("Retail Emp.", "Accommodations Emp.", "'Business' Emp."))
...
stargazer(lyndale_its[[1]], lyndale_its[[2]], lyndale_its[[3]], type = "text", title = "Interrupted Time Series- Lyndale Ave.", column.labels = c("Retail Emp.", "Accommodations Emp.", "'Business' Emp."))
