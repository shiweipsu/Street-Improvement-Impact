...
L Street's growth patterns for both retail and accommodations employment slightly lag behind the city and the control corridors, but the trends remain relatively similar until later when the city and I St. pick up retail employment growth. For accommodations employment L Street largely follows its control corridors. Considering how closely the corridors seem to track one another it seems that there has not been a noticeable effect of the new infrastructure on retail or accommodations employment.
...
The trends for M Street are more ambiguous compared to L primarily due to the fact that the construction period is too late to see any potential impacts. That being said, the pre-construction trends show M largely tracking with its controls with respect to retail employment. But M's accommodations employment trends diverge dramatically from its controls with an initial drop and then fairly smooth recovery and growth starting around 2013.  
