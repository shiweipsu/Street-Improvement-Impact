...
madison_sales$Type <- relevel(madison_sales$Type, ref = 5)

madison_agg_did <- lm(gross_sales ~ Type + prepost + Type*prepost, data=madison_sales)
madison_agg_its <- lm(gross_sales ~ ts_year + prepost + ts_year*prepost, data=madison_sales)
stargazer(madison_agg_did, title = "Madison Ave. Corridor Difference-in-Difference Estimates", type = "html")
stargazer(madison_agg_its, title = "Madison Ave. Corridor Time Series Estimates", type = "html")
...
broad_agg_did <- lm(gross_sales ~ Type + prepost + Type*prepost, data=broad_sales)
broad_agg_its <- lm(gross_sales ~ ts_year + prepost + ts_year*prepost, data=broad_sales)
stargazer(broad_agg_did, title = "Broad Ave. Corridor Difference-in-Difference Estimates", type = "html")
stargazer(broad_agg_its, title = "Broad Ave. Corridor Time Series Estimates", type = "html")
