...
stargazer(river_qcew_did_list[[1]], river_qcew_did_list[[2]],
          title = "Riverside Avenue Difference-in-Difference Estimates",
...
stargazer(franklin_qcew_list[[1]], franklin_qcew_list[[2]], title = "Franklin Ave ITS Estimates", column.labels = "Average Employment", "Total Wages")
```
