...
Our first treatment corridor is Madison Avenue, which installed separate bike lane in 2011. The control corridors are Highland Street, Jackson Avenue, and Union Avenue. Jackson Avenue and Union Street are close to the treatment corridor in southeast downtown Indianapolis while Highland Street is located in central downtown area.
...
Our first treatment corridor is Madison Avenue, which installed separate bike lane in 2010. The control corridors are Highland Street, Jackson Street, and Union Street. Jackson Street and Union Street are close to the treatment corridor in southeast downtown Indianapolis while Highland Street is located in central downtown area.
```{r message=FALSE, warning=FALSE, include=FALSE}
