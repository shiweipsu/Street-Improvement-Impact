...
central_sales_pest_retail_trend_plot <- trend_plot(central_nets1_sales_pest, industry = "Retail", industry_code = "CNS07_pest",
                                                   corridor_name = "Central Avenue", construct_year = 2012, end_year = 2013,
                                                   y_lable = "Sales", index = "Per Establishment", unit = "(in millions)")

central_sales_pest_food_trend_plot <- trend_plot(central_nets1_sales_pest, industry = "Food",industry_code = "CNS18_pest",
                                                 corridor_name = "Central Avenue", construct_year = 2012, end_year = 2013,
                                                 y_lable = "Sales", index = "Per Establishment", unit = "(in millions)")
...
central_sales_retail_indexed_trend_plot <- trend_plot(central_nets1_sales_idx, industry = "Retail",
                                                      industry_code = "CNS07_sd", corridor_name = "Central Avenue",
                                                      construct_year = 2012, end_year = 2013,
                                                      y_lable = "Sales", index = "Indexed", unit="")

central_sales_food_indexed_trend_plot <- trend_plot(central_nets1_sales_idx, industry = "Food",
