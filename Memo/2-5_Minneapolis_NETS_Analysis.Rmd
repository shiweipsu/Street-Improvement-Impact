...
central_nets1_emp$year <- as.numeric(central_nets1_emp$year)

central_emp_retail_trend_plot <- trend_plot(filter(central_nets1_emp,Type!="City" & year>2003), industry = "Retail", industry_code = "CNS07",
                                            corridor_name = "Central Avenue", construct_year = 2012, end_year = 2013,
                                            y_lable = "Employment", index = "Total", unit="")

central_emp_food_trend_plot <- trend_plot(filter(central_nets1_emp, Type!="City" & year>2003), industry = "Food",industry_code = "CNS18",
                                          corridor_name = "Central Avenue", construct_year = 2012, end_year = 2013,
                                          y_lable = "Employment", index = "Total", unit="")
...
central_emp_pest_retail_trend_plot <- trend_plot(filter(central_nets1_emp_pest, year>2003), industry = "Retail", industry_code = "CNS07_pest",
                                                 corridor_name = "Central Avenue", construct_year = 2012, end_year = 2013,
                                                 y_lable = "Employment", index = "Per Establishment", unit="")

central_emp_pest_food_trend_plot <- trend_plot(filter(central_nets1_emp_pest, year>2003), industry = "Food",industry_code = "CNS18_pest",
                                               corridor_name = "Central Avenue", construct_year = 2012, end_year = 2013,
                                               y_lable = "Employment", index = "Per Establishment", unit="")
...
central_emp_retail_indexed_trend_plot <- trend_plot(filter(central_nets1_emp_idx, year>2003), industry = "Retail", industry_code = "CNS07_sd",
                                                    corridor_name = "Central Avenue", construct_year = 2012, end_year = 2013,
                                                    y_lable = "Employment", index = "Indexed", unit="")

central_emp_food_indexed_trend_plot <- trend_plot(filter(central_nets1_emp_idx, year>2003), industry = "Food",industry_code = "CNS18_sd",
                                                  corridor_name = "Central Avenue", construct_year = 2012, end_year = 2013,
                                                  y_lable = "Employment", index = "Indexed", unit="")
...
central_sales_retail_trend_plot <- trend_plot(filter(central_nets1_sales, Type!="City" & year>2003), industry = "Retail",
                                              industry_code = "CNS07", corridor_name = "Central Avenue", construct_year = 2012, end_year = 2013,
                                              y_lable = "Sales", index = "Total", unit = "(in millions)")

central_sales_food_trend_plot <- trend_plot(filter(central_nets1_sales, Type!="City" & year>2003), industry = "Food",
                                            industry_code = "CNS18", corridor_name = "Central Avenue", construct_year = 2012, end_year = 2013,
                                            y_lable = "Sales", index = "Total", unit = "(in millions)")
...
central_sales_pest_retail_trend_plot <- trend_plot(filter(central_nets1_sales_pest, year >2003), industry = "Retail", industry_code = "CNS07_pest",
                                                   corridor_name = "Central Avenue", construct_year = 2012, end_year = 2013,
                                                   y_lable = "Sales", index = "Per Establishment", unit = "(in millions)")

central_sales_pest_food_trend_plot <- trend_plot(filter(central_nets1_sales_pest, year >2003), industry = "Food",industry_code = "CNS18_pest",
                                                 corridor_name = "Central Avenue", construct_year = 2012, end_year = 2013,
                                                 y_lable = "Sales", index = "Per Establishment", unit = "(in millions)")
...
central_sales_retail_indexed_trend_plot <- trend_plot(filter(central_nets1_sales_idx, year>2003), industry = "Retail",
                                                      industry_code = "CNS07_sd", corridor_name = "Central Avenue",
                                                      construct_year = 2012, end_year = 2013,
                                                      y_lable = "Sales", index = "Indexed", unit="")

central_sales_food_indexed_trend_plot <- trend_plot(filter(central_nets1_sales_idx, year>2003), industry = "Food",
                                                    industry_code = "CNS18_sd", corridor_name = "Central Avenue",
                                                    construct_year = 2012, end_year = 2013,
                                                    y_lable = "Sales", index = "Indexed", unit="")
...
central_emp_retail_trend_plot <- trend_plot(filter(central_nets2_emp, Type!="City" & year>2003), industry = "Retail",
                                            industry_code = "CNS07", corridor_name = "Central Avenue",
                                            construct_year = 2012, end_year = 2013,
                                            y_lable = "Employment", index = "Total", unit="")

central_emp_food_trend_plot <- trend_plot(filter(central_nets2_emp, Type!="City" & year>2003), industry = "Food",
                                          industry_code = "CNS18", corridor_name = "Central Avenue", construct_year = 2012, end_year = 2013,
                                          y_lable = "Employment", index = "Total", unit="")
...
central_emp_pest_retail_trend_plot <- trend_plot(filter(central_nets2_emp_pest, year>2003), industry = "Retail", industry_code = "CNS07_pest",
                                                 corridor_name = "Central Avenue", construct_year = 2012, end_year = 2013,
                                                 y_lable = "Employment", index = "Per Establishment", unit="")

central_emp_pest_food_trend_plot <- trend_plot(filter(central_nets2_emp_pest, year>2003), industry = "Food",industry_code = "CNS18_pest",
                                               corridor_name = "Central Avenue", construct_year = 2012, end_year = 2013,
                                               y_lable = "Employment", index = "Per Establishment", unit="")
...
central_emp_retail_indexed_trend_plot <- trend_plot(filter(central_nets2_emp_idx, year>2003), industry = "Retail", industry_code = "CNS07_sd",
                                                    corridor_name = "Central Avenue", construct_year = 2012, end_year = 2013,
                                                    y_lable = "Employment", index = "Indexed", unit="")

central_emp_food_indexed_trend_plot <- trend_plot(filter(central_nets2_emp_idx, year>2003), industry = "Food",industry_code = "CNS18_sd",
                                                  corridor_name = "Central Avenue", construct_year = 2012, end_year = 2013,
                                                  y_lable = "Employment", index = "Indexed", unit="")
...
central_sales_retail_trend_plot <- trend_plot(filter(central_nets2_sales, Type!="City" & year>2003), industry = "Retail", industry_code = "CNS07",
                                              corridor_name = "Central Avenue", construct_year = 2012, end_year = 2013,
                                              y_lable = "Sales", index = "Total", unit = "(in millions)")

central_sales_food_trend_plot <- trend_plot(filter(central_nets2_sales, Type!="City" & year>2003), industry = "Food",industry_code = "CNS18",
                                            corridor_name = "Central Avenue", construct_year = 2012, end_year = 2013,
                                            y_lable = "Sales", index = "Total", unit = "(in millions)")
...
central_sales_pest_retail_trend_plot <- trend_plot(filter(central_nets2_sales_pest, year>2003), industry = "Retail", industry_code = "CNS07_pest",
                                                   corridor_name = "Central Avenue", construct_year = 2012, end_year = 2013,
                                                   y_lable = "Sales", index = "Per Establishment", unit = "(in millions)")

central_sales_pest_food_trend_plot <- trend_plot(filter(central_nets2_sales_pest, year>2003), industry = "Food",industry_code = "CNS18_pest",
                                                 corridor_name = "Central Avenue", construct_year = 2012, end_year = 2013,
                                                 y_lable = "Sales", index = "Per Establishment", unit = "(in millions)")
...
central_sales_retail_indexed_trend_plot <- trend_plot(filter(central_nets2_sales_idx, year>2003), industry = "Retail",
                                                      industry_code = "CNS07_sd", corridor_name = "Central Avenue",
                                                      construct_year = 2012, end_year = 2013,
                                                      y_lable = "Sales", index = "Indexed", unit="")

central_sales_food_indexed_trend_plot <- trend_plot(filter(central_nets2_sales_idx, year>2003), industry = "Food",
                                                    industry_code = "CNS18_sd", corridor_name = "Central Avenue",
                                                    construct_year = 2012, end_year = 2013,
                                                    y_lable = "Sales", index = "Indexed", unit="")
...
frkl_emp_retail_trend_plot <- trend_plot(filter(frkl_nets1_emp, Type!="City" & year>2003), industry = "Retail",
                                         industry_code = "CNS07", corridor_name = "Franklin Avenue",
                                         construct_year = 2011, end_year = 2012, y_lable = "Employment", index = "Total")

frkl_emp_food_trend_plot <- trend_plot(filter(frkl_nets1_emp, Type!="City" & year>2003), industry = "Food",
                                       industry_code = "CNS18", corridor_name = "Franklin Avenue",
                                       construct_year = 2011, end_year = 2012, y_lable = "Employment", index = "Total")
...
frkl_emp_pest_retail_trend_plot <- trend_plot(filter(frkl_nets1_emp_pest, year>2003), industry = "Retail", industry_code = "CNS07_pest",
                                              corridor_name = "Franklin Avenue", construct_year = 2011, end_year = 2012,
                                              y_lable = "Employment", index = "Per Establishment")

frkl_emp_pest_food_trend_plot <- trend_plot(filter(frkl_nets1_emp_pest, year>2003), industry = "Food",industry_code = "CNS18_pest",
                                            corridor_name = "Franklin Avenue", construct_year = 2011, end_year = 2012,
                                            y_lable = "Employment", index = "Per Establishment")
...
frkl_emp_retail_indexed_trend_plot <- trend_plot(filter(frkl_nets1_emp_idx, year>2003), industry = "Retail", industry_code = "CNS07_sd",
                                                 corridor_name = "Franklin Avenue", construct_year = 2011, end_year = 2012,
                                                 y_lable = "Employment", index = "Indexed")

frkl_emp_food_indexed_trend_plot <- trend_plot(filter(frkl_nets1_emp_idx, year>2003), industry = "Food",industry_code = "CNS18_sd",
                                               corridor_name = "Franklin Avenue", construct_year = 2011, end_year = 2012,
                                               y_lable = "Employment", index = "Indexed")
...
frkl_sales_retail_trend_plot <- trend_plot(filter(frkl_nets1_sales, Type!="City"& year>2003), industry = "Retail",
                                           industry_code = "CNS07", corridor_name = "Franklin Avenue",
                                           construct_year = 2011, end_year = 2012, y_lable = "Sales",
                                           index = "Total", unit = "(in millions)")

frkl_sales_food_trend_plot <- trend_plot(filter(frkl_nets1_sales, Type!="City"& year>2003), industry = "Food",
                                         industry_code = "CNS18", corridor_name = "Franklin Avenue",
                                         construct_year = 2011, end_year = 2012, y_lable = "Sales",
                                         index = "Total", unit = "(in millions)")
...
frkl_sales_pest_retail_trend_plot <- trend_plot(filter(frkl_nets1_sales_pest, year>2003), industry = "Retail",
                                                industry_code = "CNS07_pest", corridor_name = "Franklin Avenue",
                                                construct_year = 2011, end_year = 2012, y_lable = "Sales",
                                                index = "Per Establishment", unit = "(in millions)")

frkl_sales_pest_food_trend_plot <- trend_plot(filter(frkl_nets1_sales_pest,year>2003), industry = "Food",industry_code = "CNS18_pest",
                                              corridor_name = "Franklin Avenue", construct_year = 2011, end_year = 2012,
                                              y_lable = "Sales", index = "Per Establishment", unit = "(in millions)")
...
frkl_sales_retail_indexed_trend_plot <- trend_plot(filter(frkl_nets1_sales_idx, year>2003), industry = "Retail",
                                                   industry_code = "CNS07_sd", corridor_name = "Franklin Avenue",
                                                   construct_year = 2011, end_year = 2012, y_lable = "Sales", index = "Indexed")

frkl_sales_food_indexed_trend_plot <- trend_plot(filter(frkl_nets1_sales_idx, year>2003), industry = "Food",
                                                 industry_code = "CNS18_sd", corridor_name = "Franklin Avenue",
                                                 construct_year = 2011, end_year = 2012, y_lable = "Sales", index = "Indexed")
...
frkl_emp_retail_trend_plot <- trend_plot(filter(frkl_nets2_emp, Type!="City" & year>2003), industry = "Retail",
                                         industry_code = "CNS07", corridor_name = "Franklin Avenue",
                                         construct_year = 2011, end_year = 2012, y_lable = "Employment", index = "Total")

frkl_emp_food_trend_plot <- trend_plot(filter(frkl_nets2_emp, Type!="City" & year>2003), industry = "Food",
                                       industry_code = "CNS18", corridor_name = "Franklin Avenue",
                                       construct_year = 2011, end_year = 2012, y_lable = "Employment", index = "Total")
...
frkl_emp_pest_retail_trend_plot <- trend_plot(filter(frkl_nets2_emp_pest, year>2003), industry = "Retail",
                                              industry_code = "CNS07_pest", corridor_name = "Franklin Avenue",
                                              construct_year = 2011, end_year = 2012, y_lable = "Employment", index = "Per Establishment")

frkl_emp_pest_food_trend_plot <- trend_plot(filter(frkl_nets2_emp_pest, year>2003), industry = "Food",
                                            industry_code = "CNS18_pest", corridor_name = "Franklin Avenue",
                                            construct_year = 2011, end_year = 2012, y_lable = "Employment", index = "Per Establishment")
...
frkl_emp_retail_indexed_trend_plot <- trend_plot(filter(frkl_nets2_emp_idx, year>2003), industry = "Retail",
                                                 industry_code = "CNS07_sd", corridor_name = "Franklin Avenue",
                                                 construct_year = 2011, end_year = 2012, y_lable = "Employment", index = "Indexed")

frkl_emp_food_indexed_trend_plot <- trend_plot(filter(frkl_nets2_emp_idx, year>2003), industry = "Food",
                                               industry_code = "CNS18_sd", corridor_name = "Franklin Avenue",
                                               construct_year = 2011, end_year = 2012, y_lable = "Employment", index = "Indexed")
...
frkl_sales_retail_trend_plot <- trend_plot(filter(frkl_nets2_sales, Type!="City" & year>2003), industry = "Retail",
                                           industry_code = "CNS07", corridor_name = "Franklin Avenue",
                                           construct_year = 2011, end_year = 2012,
                                           y_lable = "Sales", index = "Total", unit = "(in millions)")

frkl_sales_food_trend_plot <- trend_plot(filter(frkl_nets2_sales, Type!="City" & year>2003), industry = "Food",
                                         industry_code = "CNS18", corridor_name = "Franklin Avenue",
                                         construct_year = 2011, end_year = 2012,
                                         y_lable = "Sales", index = "Total", unit = "(in millions)")
...
frkl_sales_pest_retail_trend_plot <- trend_plot(filter(frkl_nets2_sales_pest, year>2003), industry = "Retail",
                                                industry_code = "CNS07_pest", corridor_name = "Franklin Avenue",
                                                construct_year = 2011, end_year = 2012,
                                                y_lable = "Sales", index = "Per Establishment", unit = "(in millions)")

frkl_sales_pest_food_trend_plot <- trend_plot(filter(frkl_nets2_sales_pest, year>2003), industry = "Food",
                                              industry_code = "CNS18_pest", corridor_name = "Franklin Avenue",
                                              construct_year = 2011, end_year = 2012,
                                              y_lable = "Sales", index = "Per Establishment", unit = "(in millions)")
...
frkl_sales_retail_indexed_trend_plot <- trend_plot(filter(frkl_nets2_sales_idx, year>2003), industry = "Retail",
                                                   industry_code = "CNS07_sd", corridor_name = "Franklin Avenue",
                                                   construct_year = 2011, end_year = 2012, y_lable = "Sales", index = "Indexed")

frkl_sales_food_indexed_trend_plot <- trend_plot(filter(frkl_nets2_sales_idx, year>2003), industry = "Food",
                                                 industry_code = "CNS18_sd", corridor_name = "Franklin Avenue",
                                                 construct_year = 2011, end_year = 2012, y_lable = "Sales", index = "Indexed")
