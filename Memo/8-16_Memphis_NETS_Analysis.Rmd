...
memphis_nets_bf[memphis_nets_bf$name=="Jackson Avenue",]$Type <- "Control: Jackson"
...
# one types of industry categories similar to LEHD ######################## ERROR ########################
...
# indexed employment
broad_nets1_emp_idx <- agg_index_trend_table(broad_nets1_emp, group = 1, construct_year = 2010)
...
# indexed sales
broad_nets1_sales_idx <- agg_index_trend_table(broad_nets1_sales, group = 1, construct_year = 2010)
...
# indexed employment
broad_nets2_emp_idx <- agg_index_trend_table(broad_nets2_emp, group = 1, construct_year = 2010)
...
# indexed sales
broad_nets2_sales_idx <- agg_index_trend_table(broad_nets2_sales, group = 1, construct_year = 2010)
...
broad_nets1_emp_did <- did_agg_analysis(filter(broad_nets1_emp, Type!="City" & year>2005), group = 1, endyear = 2010)
broad_nets2_emp_did <- did_agg_analysis(filter(broad_nets2_emp, Type!="City" & year>2005), group = 1, endyear = 2010)
...
broad_nets1_sales_did <- did_agg_analysis(filter(broad_nets1_sales, Type!="City" & year>2005), group = 1, endyear = 2010)
broad_nets2_sales_did <- did_agg_analysis(filter(broad_nets2_sales, Type!="City" & year>2005), group = 1, endyear = 2010)
...
# ITS
broad_nets1_emp <- broad_nets1_emp %>% mutate(Type = ifelse(Type=="Treatment: Broad", "Treatment", Type))
...
broad_nets1_emp_its <- agg_its_analysis(filter(broad_nets1_emp, Type!="City" & year>2005), group = 1, endyear = 2010)
broad_nets2_emp_its <- agg_its_analysis(filter(broad_nets2_emp, Type!="City" & year>2005), group = 1, endyear = 2010)
...
broad_nets1_sales_its <- agg_its_analysis(filter(broad_nets1_sales, Type!="City" & year>2005), group = 1, endyear = 2010)
broad_nets2_sales_its <- agg_its_analysis(filter(broad_nets2_sales, Type!="City" & year>2005), group = 1, endyear = 2010)
...
# indexed employment
madison_nets1_emp_idx <- agg_index_trend_table(madison_nets1_emp, group = 2, construct_year = 2011)
...
# indexed sales
madison_nets1_sales_idx <- agg_index_trend_table(madison_nets1_sales, group = 2, construct_year = 2011)
...
# indexed employment
madison_nets2_emp_idx <- agg_index_trend_table(madison_nets2_emp, group = 2, construct_year = 2011)
...
# indexed sales
madison_nets2_sales_idx <- agg_index_trend_table(madison_nets2_sales, group = 2, construct_year = 2011)
...
madison_nets1_emp_did <- did_agg_analysis(filter(madison_nets1_emp, Type!="City" & year>2005), group = 2, endyear = 2011)
madison_nets2_emp_did <- did_agg_analysis(filter(madison_nets2_emp, Type!="City" & year>2005), group = 2, endyear = 2011)
...
madison_nets1_sales_did <- did_agg_analysis(filter(madison_nets1_sales, Type!="City" & year>2005), group = 2, endyear = 2011)
madison_nets2_sales_did <- did_agg_analysis(filter(madison_nets2_sales, Type!="City" & year>2005), group = 2, endyear = 2011)
...
madison_nets1_emp_its <- agg_its_analysis(filter(madison_nets1_emp, Type!="City" & year>2005), group = 2, endyear = 2011)
madison_nets2_emp_its <- agg_its_analysis(filter(madison_nets2_emp, Type!="City" & year>2005), group = 2, endyear = 2011)
...
madison_nets1_sales_its <- agg_its_analysis(filter(madison_nets1_sales, Type!="City" & year>2005), group = 2, endyear = 2011)
madison_nets2_sales_its <- agg_its_analysis(filter(madison_nets2_sales, Type!="City" & year>2005), group = 2, endyear = 2011)
