...
white_plot <- dist_trend_plot(stark_race,demo = "White", demo_code = "white_perc", corridor_name = "Stark & Oak Avenue", cat = "Residence", construct_year = 2009, end_year = 2010, 79, 91)

black_plot <- dist_trend_plot(stark_race,demo = "Black", demo_code = "black_perc", corridor_name = "Stark & Oak Avenue", cat = "Residence", construct_year = 2009, end_year = 2010, 1,13)

ameindian_plot <- dist_trend_plot(stark_race,demo = "American Indian", demo_code = "ameindian_perc", corridor_name = "Stark & Oak Avenue",cat = "Residence", construct_year = 2009, end_year = 2010, 0,12)

asian_plot <- dist_trend_plot(stark_race,demo = "Asian", demo_code = "asian_perc", corridor_name = "Stark & Oak Avenue",cat = "Residence", construct_year = 2009, end_year = 2010,0,12)

hawaii_plot <- dist_trend_plot(stark_race,demo = "Native Hawaiian", demo_code = "hawaii_perc", corridor_name = "Stark & Oak Avenue", cat = "Residence", construct_year = 2009, end_year = 2010,0,12)

other_plot <- dist_trend_plot(stark_race,demo = "Two or More Races", demo_code = "other_perc", corridor_name = "Stark & Oak Avenue",cat = "Residence", construct_year = 2009, end_year = 2010,0,12)
...
hisch_under_plot <- dist_trend_plot(stark_edu,demo = "Less Than High School", demo_code = "hisch_under_perc", corridor_name = "Stark & Oak Avenue", cat = "Residence", construct_year = 2009, end_year = 2010, 0, 15)

hisch_plot <- dist_trend_plot(stark_edu,demo = "High School", demo_code = "hisch_perc", corridor_name = "Stark & Oak Avenue", cat = "Redidence", construct_year = 2009, end_year = 2010, 10, 25)

col_plot <- dist_trend_plot(stark_edu,demo = "College", demo_code = "col_perc", corridor_name = "Stark & Oak Avenue", cat = "Residence", construct_year = 2009, end_year = 2010, 12, 27)

bach_plot <- dist_trend_plot(stark_edu,demo = "Bachelor or Above", demo_code = "bach_perc", corridor_name = "Stark & Oak Avenue", cat = "Residence", construct_year = 2009, end_year = 2010,20,35)
...
gender_rac_plot <- dist_trend_plot(stark_gender_rac,demo = "Female", demo_code = "female_perc", corridor_name = "Stark & Oak Avenue", cat = "Residence", construct_year = 2009, end_year = 2010, 30, 60)
