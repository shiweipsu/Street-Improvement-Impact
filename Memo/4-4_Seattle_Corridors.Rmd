...
secondave_agg <- make_agg_trend_table(seattle_corridor, group = 1, construct_year = 2014)
secondave_agg_plot <- make_agg_trend_plot(secondave_agg, industry = "Business", corridor_name = "2nd Ave.",industry_code = "business_sd", construct_year = 2014, end_year = 2015)
...
secondave_agg_plot <- make_agg_trend_plot(secondave_agg, industry = "Retail", corridor_name = "2nd Ave.",industry_code = "CNS07_sd", construct_year = 2014, end_year = 2015)
...
secondave_agg_plot <- make_agg_trend_plot(secondave_agg, industry = "Food & Accommodations", corridor_name = "2nd Ave.",industry_code = "CNS18_sd", construct_year = 2014, end_year = 2015)
...
brwy_agg <- make_agg_trend_table(seattle_corridor, group = 2, construct_year = 2013)
brwy_agg_plot <- make_agg_trend_plot(brwy_agg, industry = "Business", corridor_name = "Broadway",industry_code = "business_sd", construct_year = 2013, end_year = 2014)
...
brwy_agg_plot <- make_agg_trend_plot(brwy_agg, industry = "Retail", corridor_name = "Broadway",industry_code = "CNS07_sd", construct_year = 2013, end_year = 2014)
...
brwy_agg_plot <- make_agg_trend_plot(brwy_agg, industry = "Food & Accommodations", corridor_name = "Broadway",industry_code = "CNS18_sd", construct_year = 2013, end_year = 2014)
...
Our second improvement corridor is Roosevelt Way, and it has two control corridors: University Way and N 45th St.They all locate in North Seattle, close to University District.
...
rsvt_agg <- make_agg_trend_table(seattle_corridor, group = 3, construct_year = 2016)
rsvt_agg_plot <- make_agg_trend_plot(rsvt_agg, industry = "Business", corridor_name = "Roosevelt",industry_code = "business_sd", construct_year = 2016, end_year = 2017)
...
rsvt_agg_plot <- make_agg_trend_plot(rsvt_agg, industry = "Retail", corridor_name = "Roosevelt",industry_code = "CNS07_sd", construct_year = 2016, end_year = 2017)
...
rsvt_agg_plot <- make_agg_trend_plot(rsvt_agg, industry = "Food & Accommodations", corridor_name = "Roosevelt",industry_code = "CNS18_sd", construct_year = 2016, end_year = 2017)
