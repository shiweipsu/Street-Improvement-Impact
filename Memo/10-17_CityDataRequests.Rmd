...
1.  Infrastructure and Buuldings
...
qcew_sample <- tibble::tribble(~CaseID, ~BizName, ~Address,~City, ~State, ~Zip, ~Jan, ~Feb, ~X, ~Y,
"1098", "Coffee Galore", "123 Fairfield", "Portland", "OR", 97212, 12, 20, 122.1, 45.2,
"2304", "Doughnuts Now", "346 Broadway", "Portland", "OR", 97210, 4, 6, 122.1, 45.3,
"3704", "Bar Bar", "769 Burnside", "Portland", "OR", 97210, 12, 13, 122.1, 45.4)

pander(qcew_sample, caption = "Sample QCEW Data")
