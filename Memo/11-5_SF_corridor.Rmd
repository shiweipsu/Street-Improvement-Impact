...
polk_nets1_emp <- polk_nets1 %>% select(-sales, -n, -emp_pest, -sales_pest) %>% spread(key = business1, emp_pest) %>% 
...
polk_sales_retail_trend_plot <- trend_plot(filter(polk_nets1_sales, Type!="City"), industry = "Retail", industry_code = "CNS07", corridor_name = "Polk Street", construct_year = 2009, end_year = 2010, y_lable = "Sales", index = "")

polk_sales_food_trend_plot <- trend_plot(filter(polk_nets1_sales, Type!="City"), industry = "Food",industry_code = "CNS18", corridor_name = "Polk Street", construct_year = 2009, end_year = 2010, y_lable = "Sales", index = "")
