...
# load nets
sf_nets <- st_read(dsn = con, query = "select a.dunsnumber as DunsNumber, a.sales90 as sales90, b.type as Type, b.fullname as name, b.buildstart as buildstart, b.buildend as buildend, b.group as corridor_group, a.geometry
FROM nets a, sf_corridor b
WHERE ST_Intersects(ST_Buffer(b.geometry, 20), a.geometry);")
