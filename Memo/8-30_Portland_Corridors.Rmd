...
portland <- portland_lehd %>% group_by(year) %>%
  ...
  mutate(CNS07_sd = CNS07/242.452,
         CNS18_sd = CNS18/225.31,
         business_sd = business/467.76,
         Type = "City") %>%
...
# DID
#employment
stark_nets1_emp$Type <- relevel(stark_nets1_emp$Type,ref = "Treatment")
stark_nets2_emp$Type <- relevel(stark_nets2_emp$Type,ref = "Treatment")
...
# sales
stark_nets1_sales$Type <- relevel(stark_nets1_sales$Type,ref = "Treatment")
stark_nets2_sales$Type <- relevel(stark_nets2_sales$Type,ref = "Treatment")
...
# ITS
stark_nets1_emp_its <- agg_its_analysis(stark_nets1_emp, group = 1, endyear = 2010)
stark_nets2_emp_its <- agg_its_analysis(stark_nets2_emp, group = 1, endyear = 2010)
