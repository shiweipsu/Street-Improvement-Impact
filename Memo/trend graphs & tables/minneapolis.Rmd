...
north_agg_idx_retail <- trend_agg_index_plot_city_LEHD(df_plot = north_agg, base = "Employment", industry = "Retail", corridor_name = "North Second Street",
                                                                control_corridor = "West Broadway Avenue", industry_code = "CNS07_sd", construct_year = 2011, end_year = 2012)

north_agg_idx_accom <- trend_agg_index_plot_city_LEHD(df_plot = north_agg, base = "Employment", industry = "Food", corridor_name = "North Second Street",
                                                               control_corridor = "West Broadway Avenue", industry_code = "CNS18_sd", construct_year = 2011, end_year = 2012)
...
north_agg <- north_agg %>% 
  mutate(Type = case_when(Type == " Improvement" ~ "Treatment",
                          Type == "Control" ~ "Control: West Broadway Avenue"))
north_agg$Type <- factor(north_agg$Type, levels = c("Treatment", "Control: West Broadway Avenue"))
...
north_agg_idx <- north_agg_idx %>% 
  mutate(Type = stringr::str_trim(Type, "both"),
         Type = case_when(Type == "Improvement" ~ "Treatment",
                          Type == "Control" ~ "Control: West Broadway Avenue"))
north_agg_idx$Type <- factor(north_agg_idx$Type, levels = c("Treatment", "Control: West Broadway Avenue"))

north_agg_retail_plot <- trend_agg_plot_LEHD_sa(north_agg, base = "Sales Revenue", industry = "Retail", corridor_name = "North Second Street",
                                               control_corridor = "West Broadway Avenue", industry_code = "CNS07", construct_year = 2011, end_year = 2012)
 
north_agg_retail_idx_plot <- trend_agg_index_plot_LEHD(north_agg_idx, base = "Sales Revenue", industry = "Retail", corridor_name = "North Second Street",
                                                       control_corridor = "West Broadway Avenue", industry_code = "CNS07_sd", construct_year = 2011, end_year = 2012)
...
north_qcew <- north_qcew %>% 
  mutate(street_type = case_when(street_type == "improvement" ~ "Treatment",
                                 street_type == "control" ~ "Control: West Broadway Avenue"))

north_qcew$street_type <- factor(north_qcew$street_type, 
                                     levels = c("Treatment", "Control: West Broadway Avenue"))
...
qc_emp_north <- trend_agg_plot_qcew(north_qcew, base="Employment", industry = "Retail", corridor_name = "North Second Street",
                                               control_corridor = "West Broadway", base_code = "avg_emp", construct_year = 2011)
 
qc_north_wages <- trend_agg_plot_qcew_d(north_qcew, base="Total Wages", industry = "Retail", corridor_name = "North Second Street",
...
qc_idx_emp_north <- trend_agg_plot_qcew_p(north_qcew, base="Employment", industry = "Retail", corridor_name = "North Second Street",
                                               control_corridor = "West Broadway", base_code = "avg_emp_idx", construct_year = 2011)
 
qc_idx_north_wages <- trend_agg_plot_qcew_p(north_qcew, base="Total Wage", industry = "Retail", corridor_name = "North Second Street",
